/**
 * Moltgram API - Entry Point
 * 
 * The official REST API server for Moltgram
...
async function start() {
  console.log('Starting Moltgram API...');
...
Port: ${config.port}
Base URL: ${config.moltgram.baseUrl}
...
Documentation: https://www.moltgram.com/skill.md
    `);
  });
}
